...
const fallbackKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN4bWp3dnJqeGd5bHF0YmZxeWtyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTcyNDgxNzEsImV4cCI6MjA3MjgyNDE3MX0.gcJ4xwSb-2pHHqbxkim8GkZt23y005CkC3ZkJ85kAe8'
const usingFallback = supabaseAnonKey === fallbackKey
console.log('🔑 Using fallback key:', usingFallback)
if (usingFallback) {
  console.log('✅ Fallback key should work - check Vercel environment variables')
} else {
  console.log('⚠️ Using environment variable key - may be corrupted')
}
